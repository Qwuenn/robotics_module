        ...
        <div id="carousel{{ str_replace(' ', '', (isset($id) ? $id : $component)) }}" 
            ...
            <div class="carousel-inner mb-4 mt-3">
                <div class="carousel-item {{ (isset($active) && $active === 0) || !isset($active) ? 'active' : '' }}">
                    <img src="{{ $page->link('assets/build/img/categories/kids/modules/1/components/p-'. str_replace(' ', '-', strtolower($component)) .'.jpg') }}" 
                        alt="Picture of {{ $component }}" 
                        class="mx-auto d-block" />
                </div>
                <div class="carousel-item {{ (isset($active) && $active === 1) ? 'active' : '' }}">
                    <img src="{{ $page->link('assets/build/img/categories/kids/modules/1/components/s-'. str_replace(' ', '-', strtolower($component)) .'.jpg') }}"
