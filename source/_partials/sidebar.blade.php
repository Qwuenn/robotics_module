    ...
    <div class="position-sticky ps-lg-3 py-lg-0 py-4 px-2">
        ...
        <ul class="nav flex-column fw-medium">
            <li class="nav-item {{ $page->selected('/categories\kids/introduction') }}">
                <a class="nav-link" href="{{ $page->link('categories/kids/introduction') }}">Introduction</a>
            </li>
            <li class="nav-item {{ $page->selected('/categories\kids/robot-car-kit') }}">
                <a class="nav-link" href="{{ $page->link('categories\kids/robot-car-kit') }}">
                    Robot Car Kit
                </a>
            </li>
            <li class="nav-item">
