...
(function ($, window, document, undefined) {
  ...
  $.quiz = function (el, options) {
    var base = this; // Access to jQuery version of element
    ...
    base.methods = {
      ...
      setup: function setup() {
        ...
        quizHtml += '</div>'; // if results screen not in DOM, add it
      ...
      answerQuestion: function answerQuestion(answerEl) {
        if (answerLocked) {
          return;
        }
      ...
      nextQuestion: function nextQuestion() {
        ...
        $('#quiz-controls').hide(); // check to see if we are at the last question
      ...
      gameOver: function gameOver(response) {
